...
#define UNITYFUSIONCLR_TARGET_ARM64 1
#elif IL2CPP_TARGET_ARMV7
#define UNITYFUSIONCLR_TARGET_ARMV7 1
#elif IL2CPP_TARGET_WINDOWS || IL2CPP_TARGET_DARWIN || IL2CPP_TARGET_LINUX || IL2CPP_TARGET_ANDROID
#if PLATFORM_ARCH_64
#define UNITYFUSIONCLR_TARGET_X64 1
#else
#define UNITYFUSIONCLR_TARGET_X86 1
#endif
#elif IL2CPP_TARGET_JAVASCRIPT
#define UNITYFUSIONCLR_TARGET_JAVASCRIPT 1
#else
#error "not support platform"
#endif

#if	PLATFORM_ARCH_64
#define UNITYFUSIONCLR_ARCH_64 1
#if IL2CPP_TARGET_ARM64
#define UNITYFUSIONCLR_ABI_ARM_64 1
#define UNITYFUSIONCLR_ABI_NAME "Arm64"
#else
#define UNITYFUSIONCLR_ABI_UNIVERSAL_64 1
#define UNITYFUSIONCLR_ABI_NAME "General64"
#endif
#else
#if IL2CPP_TARGET_JAVASCRIPT
#define UNITYFUSIONCLR_ABI_WEBGL32 1
#define UNITYFUSIONCLR_ABI_NAME "WebGL32"
#else
#define UNITYFUSIONCLR_ABI_UNIVERSAL_32 1
#define UNITYFUSIONCLR_ABI_NAME "General32"
#endif
#endif

#define PTR_SIZE IL2CPP_SIZEOF_VOID_P

#define SUPPORT_MEMORY_NOT_ALIGMENT_ACCESS  (UNITYFUSIONCLR_ARCH_64 || UNITYFUSIONCLR_TARGET_X86)
...
#if UNITYFUSIONCLR_UNITY_2019 || UNITYFUSIONCLR_UNITY_2020
