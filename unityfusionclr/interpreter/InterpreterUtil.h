...
namespace interpreter
{
	...
	inline void ExpandLocationData2StackDataByType(void* retValue, LocationDataType type)
	{
		switch (type)
		{
		case unityfusionclr::interpreter::LocationDataType::I1:
			*(int32_t*)retValue = *(int8_t*)retValue;
			break;
		case unityfusionclr::interpreter::LocationDataType::U1:
			*(int32_t*)retValue = *(uint8_t*)retValue;
			break;
		case unityfusionclr::interpreter::LocationDataType::I2:
			*(int32_t*)retValue = *(int16_t*)retValue;
			break;
		case unityfusionclr::interpreter::LocationDataType::U2:
