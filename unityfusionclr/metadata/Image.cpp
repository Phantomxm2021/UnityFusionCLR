...
namespace metadata
{
    ...
    void Image::ReadMemberRefParentFromToken(const Il2CppGenericContainer* klassGenericContainer, const Il2CppGenericContainer* methodGenericContainer, TableType tableType, uint32_t rowIndex, ResolveMemberRefParent& ret)
    {
        ...
        switch (tableType)
        {
        case unityfusionclr::metadata::TableType::TYPEREF:
            ReadTypeFromTypeRef(rowIndex, ret.type);
            break;
        case unityfusionclr::metadata::TableType::TYPEDEF:
            ReadTypeFromTypeDef(rowIndex, ret.type);
            break;
        case unityfusionclr::metadata::TableType::METHOD:
            RaiseNotSupportedException("ReadMemberRefParentFromToken. from METHOD");
            break;
        case unityfusionclr::metadata::TableType::MODULEREF:
            RaiseNotSupportedException("ReadMemberRefParentFromToken. from MODULEREF");
            break;
        case unityfusionclr::metadata::TableType::TYPESPEC:
...
#pragma region type
    ...
    readAgain:
        ...
        case IL2CPP_TYPE_VAR:
        {
            ...
            {
                //IL2CPP_ASSERT(unityfusionclr::metadata::IsInterpreterIndex(klassGenericContainer->ownerIndex));
            ...
            IL2CPP_ASSERT(unityfusionclr::metadata::IsInterpreterIndex(gp->ownerIndex));*/
            break;
        }
...
#pragma endregion
    ...
    const MethodInfo* Image::FindImplMethod(Il2CppClass* klass, const MethodInfo* method)
    {
        ...
        if (unityfusionclr::metadata::IsInterface(method->klass->flags))
        {
