...
namespace transform
{
	...
	int32_t GetSizeByReduceType(EvalStackReduceDataType type)
	{
		switch (type)
		{
		case unityfusionclr::transform::EvalStackReduceDataType::I4:
		case unityfusionclr::transform::EvalStackReduceDataType::R4:
			return 4;
		case unityfusionclr::transform::EvalStackReduceDataType::I8:
		case unityfusionclr::transform::EvalStackReduceDataType::R8:
			return 8;
		default:
		{
