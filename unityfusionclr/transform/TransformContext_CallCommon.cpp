...
default: return false;\
		...
		if (actRet == ArgCommonType::VOID)
		{
			switch (actParam)
			{
			case unityfusionclr::transform::ArgCommonType::I4:
			{
				SWITCH_INSTANCE_VOID(i4, paramCount);
				break;
			}
			case unityfusionclr::transform::ArgCommonType::I8:
			{
				SWITCH_INSTANCE_VOID(i8, paramCount);
				break;
			}
			case unityfusionclr::transform::ArgCommonType::R4:
			{
				SWITCH_INSTANCE_VOID(f4, paramCount);
				break;
			}
			case unityfusionclr::transform::ArgCommonType::R8:
			{
